...
REPOSITORY="https://github.com/skarados/Anthias.git"
ANTHIAS_REPO_DIR="/home/${USER}/screenly"
GITHUB_API_REPO_URL="https://api.github.com/repos/skarados/Anthias"
GITHUB_RELEASES_URL="https://github.com/skarados/Anthias/releases"
GITHUB_RAW_URL="https://raw.githubusercontent.com/skarados/Anthias"
DOCKER_TAG="latest"
...
function set_device_type() {
    ...
    elif grep -qF "Raspberry Pi Compute Module 5" /proc/device-tree/model; then
        export DEVICE_TYPE="pi5"
